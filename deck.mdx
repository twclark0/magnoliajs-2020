...
<img className="code-snipet"  src="./template1.png" />
...
<img className="code-snipet"  src="./template2.png" />
...
<img className="code-snipet"  src="./template3.png" />
...
<img className="code-snipet" src="./template4.png" />
...
<div>
<img style={{ width: '49%',  margin: "auto",   display: "grid",
    placeItems: "center"}} src="./es11.png" />
</div>
