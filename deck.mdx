...
ES2016 (2016) -> [].includes(), Exponentiation operator (\*\*)

<hr />
ES2017 -> Async functions
<hr />
ES2018 -> Async iteration, new RegExp stuff, Promise.prototype.finally()
<hr />
ES2019 -> Array flat() & flatMap(), Object.fromEntries(), String trimStart / End
<hr />
ES2020 -> Coalescing ??, Optional ?., dynamic import()
<hr />
...
<img style={{ display: "block", margin: "auto" }} src="./ryan.png" />
...
<div>
  <em>Tagged template literal ES2016 </em>
</div>
...
```js title="ES2017: Promise.prototype.finally()"
const state = {
  isLoading: true,
};
...
```js 1 title="Object.fromEntries ES2019"
Array of values -> object
```
...
// First promise that is a success or when all are rejected
```
...
- Adds one additional export module option
...
Animal.#middleName; // Private field '#middleName' must be declared in an enclosing class
